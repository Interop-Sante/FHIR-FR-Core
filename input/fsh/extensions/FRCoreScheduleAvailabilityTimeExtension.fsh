...
* extension[rrule].extension[bySecond] ^min = 0
...
* extension[rrule].extension[byMinute] ^min = 0
...
* extension[rrule].extension[byHour] ^min = 0
...
* extension[rrule].extension[byDay] ^min = 0
...
* extension[rrule].extension[byMonthDay] ^min = 0
...
* extension[rrule].extension[byYearDay] ^min = 0
...
* extension[rrule].extension[byWeekNo] ^min = 0
