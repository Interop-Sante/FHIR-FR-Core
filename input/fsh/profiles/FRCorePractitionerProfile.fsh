...
* qualification.code.coding[degreeR36].system ^short = "Autre diplôme obtenu"
...
* qualification.code.coding[degreeR47].system ^short = "Commission de qualification"
...
* qualification.code.coding[degreeR48].system ^short = "Diplôme de l'Etat français"
...
* qualification.code.coding[degreeR49].system ^short = "Diplôme d'Etudes Spécialisées"
...
* qualification.code.coding[degreeR50].system ^short = "DESC Groupe 1 (diplôme)"
...
* qualification.code.coding[degreeR51].system ^short = "DESC Groupe 2 (diplôme)"
...
* qualification.code.coding[degreeR52].system ^short = "Capacité (diplôme)"
...
* qualification.code.coding[degreeR53].system ^short = "Diplôme d'un pays de l'EEE"
...
* qualification.code.coding[degreeR54].system ^short = "Diplôme d'Université ou Inter-Universitaire"
...
* qualification.code.coding[degreeR55].system ^short = "Certificat d'Etude Spéciale"
...
* qualification.code.coding[degreeR57].system ^short = "Diplôme Européen d'Etudes Spécialisées"
...
* qualification.code.coding[degreeR58].system ^short = "Autre type de diplôme"
...
* qualification.code.coding[degreeR226].system ^short = "Diplôme de 2ième cycle non qualifiant"