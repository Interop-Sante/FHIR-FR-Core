...
* extension[deathPlace] ^min = 0
* extension[birthdateUpdateIndicator] ^min = 0
...
* identifier[INS-NIR].use = #official (exactly)
* identifier[INS-NIR].type 1..
* identifier[INS-NIR].type = $fr-core-v2-0203#INS-NIR "NIR" (exactly)
* identifier[INS-NIR].type from $fr-core-patient-identifier-type (extensible)
* identifier[INS-NIR].type ^binding.extension[0].url = "http://hl7.org/fhir/StructureDefinition/elementdefinition-bindingName"
* identifier[INS-NIR].type ^binding.extension[=].valueString = "IdentifierType"
...
* identifier[INS-NIR].system = "urn:oid:1.2.250.1.213.1.4.8" (exactly)
...
* identifier[INS-NIA].use = #temp (exactly)
* identifier[INS-NIA].type 1..
* identifier[INS-NIA].type = $fr-core-v2-0203#INS-NIA "NIA" (exactly)
* identifier[INS-NIA].type from $fr-core-patient-identifier-type (extensible)
* identifier[INS-NIA].type ^binding.extension[0].url = "http://hl7.org/fhir/StructureDefinition/elementdefinition-bindingName"
* identifier[INS-NIA].type ^binding.extension[=].valueString = "IdentifierType"
...
* identifier[INS-NIA].system = "urn:oid:1.2.250.1.213.1.4.9" (exactly)
...
* identifier[INS-C].use = #secondary (exactly)
* identifier[INS-C].type 1..
* identifier[INS-C].type = $fr-core-v2-0203#INS-C "INS calculé" (exactly)
...
* identifier[INS-C].type ^binding.extension[0].url = "http://hl7.org/fhir/StructureDefinition/elementdefinition-bindingName"
* identifier[INS-C].type ^binding.extension[=].valueString = "IdentifierType"
...
* identifier[INS-C].system = "urn:oid:1.2.250.1.213.1.4.2" (exactly)
...
* identifier[NDP].use = #secondary (exactly)
* identifier[NDP].type 1..
* identifier[NDP].type = $fr-core-v2-0203#NDP "Identifiant au dossier pharmaceutique" (exactly)
...
* identifier[NDP].system = "urn:oid:1.2.250.1.176.1.2" (exactly)
...
* identifier[PI].use = #usual (exactly)
* identifier[PI].type 1..
* identifier[PI].type = $fr-core-v2-0203#PI "Patient internal identifier" (exactly)
...
* identifier[RRI].use = #secondary (exactly)
* identifier[RRI].type 1..
* identifier[RRI].type = $fr-core-v2-0203#RRI "Regional registry ID" (exactly)
* identifier[RRI].type from $fr-core-patient-identifier-type (extensible)
* identifier[RRI].type ^binding.extension[0].url = "http://hl7.org/fhir/StructureDefinition/elementdefinition-bindingName"
* identifier[RRI].type ^binding.extension[=].valueString = "IdentifierType"
...
* name[usualName].use = #usual (exactly)
...
* contact.relationship[RolePerson] from FRCoreValueSetRelatedPersonRole (extensible) //TODO : à confirmer car HL7 préconise un autre VS, à mettre à jour
...
* contact.relationship[RolePerson].coding.system = "https://mos.esante.gouv.fr/NOS/TRE_R260-HL7RoleClass/FHIR/TRE-R260-HL7RoleClass" (exactly)

* contact.relationship[RelatedPerson] from FRCoreValueSetRelatedPerson (extensible) //TODO : à confirmer car HL7 préconise un autre VS, à mettre à jour
...
* contact.relationship[RelatedPerson].coding.system = "https://mos.esante.gouv.fr/NOS/TRE_R216-HL7RoleCode/FHIR/TRE-R216-HL7RoleCode" (exactly)
